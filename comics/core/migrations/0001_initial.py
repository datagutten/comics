    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Name of the comic',
                    max_length=100)),
                ('slug', models.SlugField(help_text='For file paths and URLs',
                    unique=True, max_length=100, verbose_name='Short name')),
                ('language', models.CharField(
                    help_text='The language of the comic', max_length=2,
                ...
                ('end_date', models.DateField(
                    help_text='Last published at, if comic has been '
                    'cancelled', null=True, blank=True)),
                ('rights', models.CharField(
                    help_text='Author, copyright, and/or licensing '
                    'information', max_length=100, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comic', models.ForeignKey(to='core.Comic',
                    on_delete=models.CASCADE)),
                ('images', models.ManyToManyField(related_name='releases',
                    to='core.Image')),
            ],
            options={
